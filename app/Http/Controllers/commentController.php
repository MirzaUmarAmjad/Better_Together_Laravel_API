...
class commentController extends Controller
{
  ...
  public function store(Request $request) {
      ...
      $user->description = $request->input('description');  //retrieving user inputs
  ...
  //viewing a particular User from a database
     return User::firstOrFail()->where('event_id', $id); //searches for the object in the database using its id and returns it.
  ...
  public function update(Request $request, $id) {
      ...
      $user = Comment::findorFail($id); // uses the id to search values that need to be updated.
       $user->user_id = $request->input('user_id'); //retrieving user inputs
      $user->event_id = $request->input('event_id');  //retrieving user inputs
      $user->description = $request->input('description');  //retrieving user inputs
  ...
  public function destroy($id) {
      //deleting data
     $user = Comment::findorFail($id); //searching for object in database using ID
